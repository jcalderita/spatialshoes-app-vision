...
extension ShoeModel {
    static let firstTest = ShoeModel(
        ...
        gender: "Unisex",
        weight: 1.2,
        colors: ["Negro", "Marr\u{00f3}n"],
        warranty: 2,
        certifications: ["Certificaci\u{00f3}n de Calidad", "Hecho a mano"]
    )
    static let secondTest = ShoeModel(
        ...
        warranty: 2,
        certifications: ["Certificaci\u{00f3}n de Sostenibilidad", "Hecho a mano"]
    )
}
